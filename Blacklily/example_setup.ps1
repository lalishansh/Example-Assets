...
DnExampleZipIfFilesUnAvailable -DestPath "$pwd/src/_blogs" -URL https://raw.githubusercontent.com/lalishansh/Example-Assets/main/Blacklily/_blogs.zip
DnExampleZipIfFilesUnAvailable -DestPath "$pwd/src/_posts" -URL https://raw.githubusercontent.com/lalishansh/Example-Assets/main/Blacklily/_posts.zip
